...
class MemberAndExpensesForMember extends StatefulWidget {
  final List allMember;

  const MemberAndExpensesForMember({Key? key, required this.allMember})
      : super(key: key);
...
class _MemberAndExpensesState extends State<MemberAndExpensesForMember> {
  int _checkedCount = 0;
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: List.generate(
                    ...
                    (index) => allMemberAndBillCardForMember(
...
class allMemberAndBillCardForMember extends StatefulWidget {
  final Map allMember;
  const allMemberAndBillCardForMember(
      {Key? key,
  ...
  @override
  State<allMemberAndBillCardForMember> createState() =>
      _allMemberAndBillCardState();
}

class _allMemberAndBillCardState extends State<allMemberAndBillCardForMember> {
