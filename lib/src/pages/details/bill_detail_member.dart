...
class BillDetailMemberPage extends StatefulWidget {
  final String partyID;
  const BillDetailMemberPage({
    this.partyID = "",
    super.key,
  });

  @override
  State<BillDetailMemberPage> createState() => _BillDetailMemberPageState();
}

class _BillDetailMemberPageState extends State<BillDetailMemberPage> {
...
//     // Ensure 'payment' value is a double
